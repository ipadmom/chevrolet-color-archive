...
class GapInventoryRefreshTest(unittest.TestCase):
    ...
    def test_specialty_subset_overlays_a_governing_palette(self) -> None:
        ...
        self.assertEqual(69, len(application_rows))
        self.assertEqual(
            928,
            sum(
                listing["evidence_class"] == "specialty_palette_subset"
    ...
    def test_specialty_candidate_ledger_does_not_promote_unreviewed_pages(self) -> None:
        ...
        self.assertEqual(892, len(specialty["app_publication_records"]))
        self.assertEqual(8, len(specialty["verified_not_published"]))
        self.assertEqual(14, len(specialty["usda_primary_sources"]))
        ...
        self.assertEqual(11, len(specialty["rejected_or_unresolved_leads"]))
        self.assertEqual(
            89,
        ...
        self.assertEqual({"visually_verified_exact_snapshot"}, modern_statuses)
        self.assertEqual(
            24,
            sum(
